...
void fusion(int l, int m, int r) {
    ...
    // Mettre à jour la visualisation après chaque

        Render();
        //délai entre chaque étape
        usleep(2000000);//est utilisée pour ralentir l'animation de tri afin que vous puissiez visualiser chaque étape du tri par fusion
  // est une pause de 2 secondes
    }
...
int main() {
    ...
    // Boucle principale
    while (!WindowShouldClose())//garantit que le programme reste dans la boucle tant que la fenêtre est ouverte.
    {
